<script lang="ts">
	...
	let { icon, label, isActive, isEnabled = false, onClick }: Props = $props();
</script>

<button
	onclick={onClick}
	class="group relative flex h-12 w-12 cursor-pointer items-center justify-center rounded-lg transition-colors {isActive
